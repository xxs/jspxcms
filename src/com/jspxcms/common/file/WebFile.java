...
public class WebFile {
	...
	public static void sort(List<WebFile> list, String sort,
		...
		if ("name".equals(sort)) {
			comp = "desc".equals(sortDirection) ? NAME_DESC : NAME_ASC;
		} else if ("lastModified".equals(sort)) {
			comp = "desc".equals(sortDirection) ? LASTMODIFIED_DESC
					: LASTMODIFIED_ASC;
		} else if ("type".equals(sort)) {
			comp = "desc".equals(sortDirection) ? TYPE_DESC : TYPE_ASC;
		} else if ("length".equals(sort)) {
			comp = "desc".equals(sortDirection) ? LENGTH_DESC : LENGTH_ASC;
		} else {
			comp = NAME_ASC;
		}
