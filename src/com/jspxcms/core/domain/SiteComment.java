...
public class SiteComment implements Configurable {
	 ...
	 */
	public static final String MODE = "comment_mode";
	/**
	 * 审核模式。0：关闭审核，1：游客需审核，2：游客和会员需审核，3：游客、会员、管理员都需审核
	 */
	public static final String AUDIT_MODE = "comment_auditMode";
	/**
	 * 验证码模式。0：关闭验证码，1：游客需验证码，2：游客和会员需验证码，3：游客、会员、管理员都需验证码
	 */
	public static final String CAPTCHA_MODE = "comment_captchaMode";
	/**
	 * 评论最大长度
	 */
	public static final String MAX_LENGTH = "comment_maxLength";
