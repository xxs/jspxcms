...
public class SensitiveWord implements java.io.Serializable {
	...
	@TableGenerator(name = "tg_cms_sensitive_word", pkColumnValue = "cms_sensitive_word", table = "t_id_table", pkColumnName = "f_table", valueColumnName = "f_id_value", initialValue = 1, allocationSize = 1)
