...
public interface FriendlinkService {
	public List<Friendlink> findList(Integer siteId, Map<String, String[]> params);

	public RowSide<Friendlink> findSide(Integer siteId, Map<String, String[]> params, Friendlink bean, Integer position, Sort sort);
