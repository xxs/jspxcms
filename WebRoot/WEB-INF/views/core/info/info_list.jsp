...
<form id="searchForm" action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  ...
	  <label class="c-lab"><s:message code="info.tagKeywords"/>: <input type="text" name="search_CONTAIN_JinfoTags.Jtag.name" value="${requestScope['search_CONTAIN_JinfoTags.Jtag.name'][0]}" style="width:100px;"/></label>
	  <label class="c-lab"><s:message code="beginTime"/>: <f:text name="search_GTE_publishDate_Date" value="${search_GTE_publishDate_Date[0]}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" style="width:80px;"/></label>
