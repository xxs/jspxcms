...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  ...
	  <label class="c-lab"><s:message code="user.realName"/>: <input type="text" name="search_CONTAIN_Jdetails.realName" value="${requestScope['search_CONTAIN_Jdetails.realName'][0]}" style="width:120px;"/></label>
