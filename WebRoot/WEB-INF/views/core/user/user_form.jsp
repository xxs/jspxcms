...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="35%">
	    ...
	    <f:text id="orgIdNameDisplay" value="${org.displayName}" class="required" readonly="readonly" style="width:160px;"/><input id="orgIdButton" type="button" value="<s:message code='choose'/>"/>
	    <script type="text/javascript">
	    $(function(){
