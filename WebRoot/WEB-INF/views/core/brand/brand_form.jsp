...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="brand.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    <td class="in-lab" width="15%"><s:message code="brand.description"/>:</td>
  ...
  <tr>
    <td class="in-lab" width="15%"><s:message code="brand.recommend"/>:</td>
    ...
    <td class="in-lab" width="15%"><em class="required">*</em><s:message code="brand.status"/>:</td>
    <td class="in-ctt" width="35%">
    	<label><f:radio name="status" value="0" checked="${bean.status}" default="0"/><s:message code="brand.status.0"/></label>
    	<label><f:radio name="status" value="1" checked="${bean.status}"/><s:message code="brand.status.1"/></label>
    </td>
  </tr>
  <tr>
    <td colspan="4" class="in-opt">
